    ...
    def spec: Spec[Any, Any] = suite("MvnArgParser")(
        ...
        suite("parse - skipTests")(
            ...
            test("skipTests properties are not included in user properties") {
                ...
                assertTrue(cmd.properties == Map("foo" -> "bar"))
            }
        ),
